...
{
	std::cout << "Default FragTrap constructor with HP = "<< HP << " EP = " << EP << " and AP = " << AP << std::endl;
}
...
FragTrap::FragTrap(const std::string name): ClapTrap(name)
{
	...
	FragTrap::EP = 100;
	FragTrap::AP = 30;
	std::cout << "FragTrap Constructor of "<< this->Name <<" HP = "<< HP << " EP = " << EP << " and AP = " << AP << std::endl;
}
...
FragTrap::~FragTrap()
{
	std::cout << "FragTrap Destructor of  "<< this->Name << std::endl;
}

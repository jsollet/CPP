...
{
	std::cout <<std::endl << "Default ClapTrap constructor " << std::endl;
}

ClapTrap::ClapTrap(const std::string name):  Name(name) , HP(10), EP(10), AP(0)
{
	std::cout << std::endl << "Constructor CT Name = "<< this->Name << std::endl;
	std::cout << "Constructor CT HP = "<< this->HP << std::endl;
	std::cout << "Constructor CT EP = "<< this->EP << std::endl;
	std::cout << "Constructor CT AP = "<< this->AP << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap &rhs): Name(rhs.getName()), HP(rhs.getHP()), EP(rhs.getEP()), AP(rhs.getAP())
{
	std::cout << std::endl <<"Copy constructor "<< this->Name <<" HP = "<< HP << " EP = " << EP << " and AP = " << AP << std::endl;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "ClapTrap Destructor of  "<< this->Name << " (adress = " << &this->Name << " )"<< std::endl;
}
